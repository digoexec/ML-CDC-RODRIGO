...
def responder(mensagem: str) -> str:
    ...
    # --- DÚVIDAS CLÍNICAS COMUNS ---
        ...
        return (
            "Diabetes é uma doença causada pelo aumento da glicose no sangue. "
            "Ela acontece quando o organismo não produz ou não utiliza corretamente a insulina."
        )

    elif msg == "o que é glicemia":
        return (
            "Glicemia é a quantidade de glicose presente no sangue. "
            "Esse exame ajuda no diagnóstico e controle do diabetes."
        )

    elif msg == "o que é vacina":
        return (
            "Vacinas estimulam o sistema imunológico a produzir proteção "
