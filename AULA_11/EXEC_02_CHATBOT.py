...
BASE_CONHECIMENTO = {
    ...
    "saudacao": {
        ...
        "diabetes": {
        "keywords": ["diabetes", "diabético", "diabetico",
                     "insulina", "taxa de açúcar"],
        "resposta": (
            "DIABETES:\n"
            "É uma doença em que a glicose no sangue fica elevada.\n"
            "Isso acontece quando o organismo não produz ou não utiliza "
            "corretamente a insulina.\n"
            "O acompanhamento médico é fundamental para o controle."
        )
    },
