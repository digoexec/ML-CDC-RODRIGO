...
def gerar_base_faq() -> pd.DataFrame:
    ...
    dados = [
        ...
        },
        {
            ...
            "intencao": "info_sedentarismo",
            "pergunta": "sedentarismo faz mal para o coração",
            "resposta": "Sim. O sedentarismo aumenta o risco de obesidade, hipertensão, diabetes e doenças cardiovasculares."
        },
        {
            "id": 43,
            "categoria": "tabagismo",
            "intencao": "info_tabagismo",
            "pergunta": "fumar aumenta risco de infarto",
            "resposta": "Sim. O tabagismo aumenta muito o risco cardiovascular e prejudica vasos sanguíneos e pulmões."
        },
        {
            "id": 44,
            "categoria": "tabagismo",
            "intencao": "info_tabagismo",
            "pergunta": "parar de fumar melhora a saúde",
            "resposta": "Sim. Após parar de fumar, o risco cardiovascular começa a diminuir já nos primeiros meses."
        },
        {
            "id": 45,
            "categoria": "tabagismo",
            "intencao": "info_tabagismo",
            "pergunta": "cigarro causa pressão alta",
            "resposta": "A nicotina aumenta temporariamente a pressão arterial e acelera os batimentos cardíacos."
},
...
class ChatbotTFIDF:
    ...
    def __init__(self, base: pd.DataFrame, threshold: float = 0.40):
        """
